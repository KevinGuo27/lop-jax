...
def load_task_data(data_path, class_order, task, classes_per_task, transform_train, transform_test,
    ...
    def train(lr, er_lr, rng):
        ...
        def update_task(runner_state, active_classes, task):
            def update_erbatch(runner_state, batch_idx, active_classes):
                ...
                accuracy_runner_state, (loss, accuracy) = jax.lax.scan(update_accuracy, accuracy_runner_state, jnp.arange(0, args.er_batch * args.mini_batch_size, args.mini_batch_size), args.er_batch, active_classes)
